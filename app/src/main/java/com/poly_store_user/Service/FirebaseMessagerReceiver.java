package com.poly_store_user.Service;
...
import com.poly_store_user.activity.MainActivity;
...
public class FirebaseMessagerReceiver extends FirebaseMessagingService {
    ...
    private RemoteViews customView(String title, String body){
        ...
        remoteViews.setImageViewResource(R.id.imgnoti, R.drawable.ic_baseline_shopping_bag_24);
        return remoteViews;
    }
}
